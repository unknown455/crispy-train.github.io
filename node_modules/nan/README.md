...
With new enough compilers available on OSX, the versions of V8 headers correspondending to Node.js 0.12
...
This can be worked around by patching your local versions of v8.h correspondending to Node 0.12 to make
