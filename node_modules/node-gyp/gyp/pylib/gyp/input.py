...
class DependencyGraphNode(object):
  ...
  def DirectDependencies(self, dependencies=None):
    ...
    for dependency in self.dependencies:
      # Check for None, correspondending to the root node.
...
def ProcessListFiltersInDict(name, the_dict):
  ...
  for key, value in the_dict.iteritems():
    ...
    if list_key not in the_dict:
      # This happens when there's a list like "sources!" but no correspondending
  ...
  for list_key in lists:
    ...
    # item in list_actions identifies whether the correspondending item in
...
def Load(build_files, variables, includes, depth, generator_input_info, check,
  ...
  # track of the keys correspondending to "target" files.
