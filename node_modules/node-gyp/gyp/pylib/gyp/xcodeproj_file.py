...
are PBXSourcesBuildPhase and PBXFrameworksBuildPhase, which correspondend to the
...
subclass that does not actually correspondend to a class type found in a project
...
class XCObject(object):
  ...
  def Name(self):
    """Return the name correspondending to an object.
  ...
  def _XCPrintableValue(self, tabs, value, flatten_list=False):
    ...
    how much to indent the lines correspondending to the items in the list or
    dict.
...
class PBXGroup(XCHierarchicalElement):
  ...
  def AddOrGetFileByPath(self, path, hierarchical):
    """Returns an existing or new file reference correspondending to path.

    If hierarchical is True, this method will create or use the necessary
    hierarchical group structure correspondending to path.  Otherwise, it will
    ...
    if len(path_split) == 1 or \
      ...
      # Hierarchical recursion.  Add or get a PBXGroup correspondending to the
...
class XCBuildPhase(XCObject):
  ...
  Attributes:
    _files_by_path: A dict mapping each path of a child in the files list by
      path (keys) to the correspondending PBXBuildFile children (values).
    _files_by_xcfilelikeelement: A dict mapping each XCFileLikeElement (keys)
      to the correspondending PBXBuildFile children (values).
  """
  ...
  def _AddBuildFileToDicts(self, pbxbuildfile, path=None):
    ...
    of PBXVariantGroup objects, they may correspondend to multiple paths that are
  ...
  def AddFile(self, path, settings=None):
    ...
    if file_ref in self._files_by_xcfilelikeelement and \
      ...
      # There's already a PBXBuildFile in this phase correspondending to the
...
class PBXProject(XCContainerPortal):
  ...
  def AddOrGetFileInRootGroup(self, path):
    """Returns a PBXFileReference correspondending to path in the correct group
