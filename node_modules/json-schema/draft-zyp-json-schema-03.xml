			...
			<section title="uniqueItems" anchor="uniqueItems">
				...
				<t>
					...
					<list>
						...
						<t>are arrays, contains the same number of items, and each item in the array is equal to the correspondending item in the other array; or</t>
						<t>are objects, contains the same property names, and each property in the object is equal to the correspondending property in the other object.</t>
					</list>
				</t>
			</section>
				...
				<section title="Link Description Object">
					...
					<section title="href">
						<t>
							...
							object, if property values exist for the correspondending variables
