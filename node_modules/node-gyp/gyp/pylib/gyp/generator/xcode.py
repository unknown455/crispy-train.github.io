...
generator_default_variables = {
  ...
  # and be constant within the context of a project, correspondending to a single
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  for qualified_target in target_list:
    ...
    for rule in spec_rules:
      ...
      # correspondending rule_source or to any specified additional input, the
      # rule action must be performed to generate the concrete outputs.

      # concrete_outputs_by_rule_source will have an item at the same index
      # as the rule['rule_sources'] that it correspondends to.  Each item is a
